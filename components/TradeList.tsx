...
// Individual trade row component for virtualization
const TradeRow: React.FC<TradeRowProps> = ({ index, style, data }) => {
  ...
  return (
    ...
    >
      ...
      <div className="px-6 py-4 whitespace-nowrap text-sm text-right font-medium font-mono">
        $
      ...
      <div className="px-6 py-4 whitespace-nowrap text-sm text-right font-medium">
        {trade.amount.toLocaleString()}
      </div>
      <div className="px-6 py-4 whitespace-nowrap text-sm text-right text-muted-foreground">
        {valueBTC.toFixed(8)}
      </div>
      <div
...
// Header component for the virtualized list
const TradeHeader: React.FC = () => (
  <div className="bg-secondary/50 border-b border-border sticky top-0 z-10">
    <div className="px-6 py-4 text-left text-xs font-bold text-muted-foreground uppercase tracking-wider">
      Date
    </div>
    <div className="px-6 py-4 text-left text-xs font-bold text-muted-foreground uppercase tracking-wider">
      Symbol
    ...
    <div className="px-6 py-4 text-right text-xs font-bold text-muted-foreground uppercase tracking-wider">
      Price
    </div>
    <div className="px-6 py-4 text-right text-xs font-bold text-muted-foreground uppercase tracking-wider">
      Size
