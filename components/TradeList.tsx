            ...
            <table className="min-w-full divide-y divide-border">
                <thead className="bg-secondary/50">
                    <tr>
                        ...
                        <th className="px-6 py-4 text-left text-xs font-bold text-muted-foreground uppercase tracking-wider">Symbol</th>
                        <th className="px-6 py-4 text-left text-xs font-bold text-muted-foreground uppercase tracking-wider">Side</th>
                        <th className="px-6 py-4 text-right text-xs font-bold text-muted-foreground uppercase tracking-wider">Price</th>
                        <th className="px-6 py-4 text-right text-xs font-bold text-muted-foreground uppercase tracking-wider">Size</th>
                        <th className="px-6 py-4 text-right text-xs font-bold text-muted-foreground uppercase tracking-wider">Value (BTC)</th>
                        <th className="px-6 py-4 text-right text-xs font-bold text-muted-foreground uppercase tracking-wider">Fee (BTC)</th>
                    </tr>
                </thead>
                            ...
                            <tr key={trade.id} className="hover:bg-secondary/50 transition-colors">
                                ...
                                <td className="px-6 py-4 whitespace-nowrap">
                                    <div className="flex items-center gap-2">
                                        <span className={`px-2 py-1 text-xs font-bold rounded-full uppercase tracking-wide ${trade.side === 'buy'
                                ...
                                <td className={`px-6 py-4 whitespace-nowrap text-sm text-right font-medium ${feeBTC < 0 ? 'text-emerald-500' : 'text-amber-500'
                                    }`}>
                                    {feeBTC >= 0 ? '' : '+'}{Math.abs(feeBTC).toFixed(8)}
                                </td>
                            </tr>
                        );
                    })}
