        ...
        <tbody className="divide-y divide-gray-200 dark:divide-gray-800">
          {positions.map(pos => (
            <tr key={pos.id} className="hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
              ...
              <td
                className={`px-6 py-4 whitespace-nowrap text-sm font-bold ${pos.side === 'long' ? 'text-green-600' : 'text-red-600'}`}
              >
              ...
              <td
                className={`px-6 py-4 whitespace-nowrap text-sm text-right font-bold ${pos.realizedPnl >= 0 ? 'text-green-600' : 'text-red-600'}`}
              >
