 ...
 */
export function isFeatureEnabled(feature: keyof Pick<FeatureFlags, 'polyEnabled' | 'kalshiEnabled'>): boolean {
 ...
 */
export function getResolutionMode(propertyKey: string): 'static' | 'dynamic' | 'volatile' | 'unknown' {
...
export const rollbackConditions = {
  ...
  cacheHitRatioThreshold: 0.60,  // 60% cache hit ratio
