...
export class ExchangeManager {
     ...
     */
    public async setActiveExchange(exchangeName: string, credentials: ExchangeCredentials): Promise<void> {
     ...
     */
    public async getExchangeWithHealth(exchangeName: string): Promise<{ exchange: any, health: any }> {
        const exchange = this.getExchange(exchangeName);
